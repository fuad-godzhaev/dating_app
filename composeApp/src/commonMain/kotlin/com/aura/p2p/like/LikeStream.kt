...
const val LIKE_PROTOCOL_ID: String = "/aura/like/1.0.0"

/** A like is one small signed envelope; 64 KiB is generous. */
const val LIKE_MAX_FRAME: Int = 64 * 1024

/**
 * Delivers a signed like ([com.aura.p2p.transport.wire.SignedEnvelope] wire
...
class Libp2pLikeStreamClient(private val transport: Transport) : LikeStreamClient {
