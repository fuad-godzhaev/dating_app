...
/**
 * Request on `/aura/mailbox/1.0.0` (ADR-0001 / M5). One protocol, two ops:
...
data class MailboxRequest(
    @SerialName($$"$type") val type: String = "com.aura.p2p.mailboxRequest",
    val op: String,
...
data class MailboxResponse(
    @SerialName($$"$type") val type: String = "com.aura.p2p.mailboxResponse",
