...
import com.aura.p2p.transport.LIBP2P_MAX_FRAME
...
const val PROFILE_PROTOCOL_ID: String = "/aura/profile/1.0.0"
...
class Libp2pProfileStreamClient(private val transport: Transport) : ProfileStreamClient {
