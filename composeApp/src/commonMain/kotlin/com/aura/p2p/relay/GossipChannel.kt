...
import com.aura.p2p.transport.GossipMessage
 ...
 * [com.aura.p2p.fetch.ProfileStreamClient] seam).
 */
...
class TransportGossipChannel(private val transport: Transport) : GossipChannel {
