 ...
 * separately from the Ed25519 transport key (see [peerIdFromEd25519]).
 */
object PeerIdentity {
    ...
    fun peerIdFromEd25519(rawPublicKey: ByteArray): String =
        TODO("B.3/B.4: PeerId = base58btc(identity-multihash(protobuf PublicKey{Ed25519,raw})); the go-libp2p host derives this from the transport seed - cross-check the Kotlin value against the Go PeerId once the .aar is wired")
