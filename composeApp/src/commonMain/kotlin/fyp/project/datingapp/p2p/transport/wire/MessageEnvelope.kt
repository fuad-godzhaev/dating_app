 ...
 *
 * Carried online over `/datingapp/message/1.0.0` and, when the recipient is offline,
 * deposited at a cacheHolder over `/datingapp/mailbox/1.0.0`.
 */
@Serializable
data class MessageEnvelope(
    @SerialName($$"$type") val type: String = "fyp.project.datingapp.p2p.message",
